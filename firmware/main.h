...
#define SIGNAL_PULSE_DISTANCE_MIN_MS		(10)
#define SIGNAL_PULSE_DISTANCE_MAX_MS		(30)
...
#define SPEED_FILTER_DEFAULT			(3)

// Sanwa VG6DR
#define CHANNEL_PULSE_MAXIMUM			(1800)
#define CHANNEL_PULSE_MINIMUM			(1200)
